...
using ISSolutions.Home.Models;

namespace ISSolutions.Home.Controllers
{
    [Authorize]
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            var model = new IndexViewModel
            {
                ...
                PhoneNumber = await UserManager.GetPhoneNumberAsync(userGuid),
                TwoFactor = await UserManager.GetTwoFactorEnabledAsync(userGuid),
                Logins = await UserManager.GetLoginsAsync(userGuid),
